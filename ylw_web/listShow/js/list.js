...
function comment(id,num,iNow){
	...
	//var oMoreComment=getClass(oSay,'more_comment')[0];
...
//切换主图
var paddingLeft=parseInt(getStyle(aBoxBtn[1],'padding-left'));
console.log(paddingLeft)

oBoxUl.style.width=(aBoxBtn[0].offsetWidth+paddingLeft)*aBoxBtn.length+'px';

oBoxNext.onclick=function(){
   oBoxUl.style.left=-(oBoxUl.offsetWidth-oBoxBot.offsetWidth)+'px'; 
}
...
//点击切换详情内容+快速导航
var quickArr=[640,970,1446,1907,2165,2412,2853, 2950];
...
window.onscroll=function(ev){
	...
	}else if(scrollTop>=900&&scrollTop<1400){
		aSelBtn[1].className='on';
	}else if(scrollTop>=1400&&scrollTop<1900){
