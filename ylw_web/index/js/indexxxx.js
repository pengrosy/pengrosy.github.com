...
var provinces = province.getElementsByTagName('a')
...
document.onclick = function(ev){
  var ev = ev || window.event;
  if( ev.target.parentNode.parentNode.id != 'allProvince' && ev.target.id != 'search' && ev.target.parentNode.id != 'allProvince' ){
